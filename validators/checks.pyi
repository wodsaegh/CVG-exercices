...
class ElementContainer:
    ...
    @classmethod
    def from_tags(
        cls, tags: List[Tag], css_validator: CssValidator) -> "ElementContainer": ...
...
class BoilerplateTestSuite(TestSuite):
    ...
    def __init__(self, name: str, content: str,
                 check_recommended: bool = True, check_minimal: bool = False): ...


class HtmlSuite(BoilerplateTestSuite):
    allow_warnings: bool

    def __init__(self, content: str, check_recommended: bool = True,
                 allow_warnings: bool = True, abort: bool = True, check_minimal: bool = False): ...
